...
namespace NHibernate.Metadata
{
        ...
        : IPropertyInfo
    {
        ...
        public PropertyMapInfo(IType type, string name)
        {
            if (type == null)
                throw new System.Exception("The object Type cannot be null.");

            if (name == null || name.Trim().Equals(string.Empty))
                throw new System.Exception("The property name cannot be null or empty.");
