...
namespace NHibernate.Metadata
{
        ...
        : IPersistentClassInfo
    {
        ...
        /// <returns></returns>
        public System.Type GetMappedClass(EntityMode mode)
        {
        ...
        {
            if (instance == null)
                throw new MissingMetadataException("The instance to get property value cannot be null.");
        ...
        public object[] GetPropertyValues(object instance, string[] propertyNames, EntityMode mode)
        {
            ...
            if (propertyNames == null)
                throw new MissingMetadataException("PropertyNames cannot be null");
        ...
        {
            if (instance == null)
                throw new MissingMetadataException("The instance to set property value cannot be null.");
        ...
        {
            if (instance == null)
                throw new MissingMetadataException("The instance to set property values cannot be null.");

            if (values == null)
                throw new MissingMetadataException("Collection with property values cannot be null.");
